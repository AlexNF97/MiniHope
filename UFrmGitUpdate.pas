...
uses
  ...
  Vcl.ExtCtrls, Vcl.ComCtrls, Vcl.Buttons, REST.Types, REST.Client, System.ImageList, Vcl.ImgList,
  GetVer, FormatFileSizeMod, System.StrUtils, Data.Bind.Components, Data.Bind.ObjectScope;
...
type
  TFrmGitUpdate = class(TForm)
    ...
    sLVFiles: TListView;
    mmInfo: TMemo;
    sEdURLApiReliases: TEdit;
    sBtnCheckUpdate: TButton;
    sBtnUpdate: TButton;
